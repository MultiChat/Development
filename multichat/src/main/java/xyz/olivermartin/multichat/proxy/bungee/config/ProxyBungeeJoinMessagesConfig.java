...
import xyz.olivermartin.multichat.proxy.common.config.ProxyJoinMessagesConfig;

public class ProxyBungeeJoinMessagesConfig extends ProxyJoinMessagesConfig {

	private Configuration config;

	public ProxyBungeeJoinMessagesConfig(File configPath, String fileName) {
