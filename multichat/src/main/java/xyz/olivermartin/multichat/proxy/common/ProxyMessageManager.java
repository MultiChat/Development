...
public class ProxyMessageManager {
	...
	private ProxyMessagesConfig config;
	private Map<String,String> defaultMessages;
	private String prefix;

	public ProxyMessageManager(ProxyMessagesConfig config) {

		this.config = config;
		this.defaultMessages = setDefaultMessages();

	}

	private Map<String,String> setDefaultMessages() {
	...
	public String getPrefix() {
		...
		if (config.getMultiChatConfig().containsNode("prefix")) {
			return config.getMultiChatConfig().getString("prefix");
		} else {
			return defaultMessages.get("prefix");
		}
	...
	public String getMessage(String id) {
		...
		MultiChatConfig mcConfig = config.getMultiChatConfig();
		if (mcConfig.containsNode(id)) return mcConfig.getString(id);
	...
	public void sendMessage(MultiChatProxyCommandSender sender, String id) {
		sender.sendColouredMessage(getPrefix() + getMessage(id));
	}

	public void sendSpecialMessage(MultiChatProxyCommandSender sender, String id, String special) {
		sender.sendColouredMessage(prefix + getMessage(id).replaceAll("%SPECIAL%", special));
	}

	public void sendSpecialMessageWithoutPrefix(MultiChatProxyCommandSender sender, String id, String special) {
		sender.sendColouredMessage(getMessage(id).replaceAll("%SPECIAL%", special));
	}
